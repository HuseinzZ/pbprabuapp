        ...
        <section className="lg:col-span-3 bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-xl shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="p-5 border-b border-slate-200 dark:border-gray-900 bg-slate-50 dark:bg-gray-800 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-end gap-3">
              <div className="w-full sm:w-auto">
                <label className="block text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Kategori</label>
                <select
                  value={filters.category}
                  onChange={(e) => handleFilterChange({ category: e.target.value })}
                  className="w-full sm:w-auto px-3 py-2 bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-500/10 dark:focus:ring-brand-500/20 outline-none rounded-lg text-xs transition-all dark:text-white"
              ...
              <div className="w-full sm:w-auto">
                <label className="block text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Tampilkan</label>
                <select
                  ...
                  className="w-full sm:w-auto px-3 py-2 bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-500/10 dark:focus:ring-brand-500/20 outline-none rounded-lg text-xs transition-all dark:text-white"
                  title="Jumlah data yang ditampilkan"
                >
              ...
              <div className="w-full sm:w-auto">
                <label className="block text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Urutan</label>
                <select
              ...
              <button
                ...
                className="px-4 py-2 bg-brand-600 hover:bg-brand-700 text-white text-xs font-bold rounded-lg flex items-center justify-center gap-2 shadow-sm transition-all duration-150 cursor-pointer shrink-0 w-full sm:w-auto"
              >
                    ...
                    >
                      ...
                      <div className="relative aspect-video bg-slate-800 overflow-hidden cursor-pointer">
                        ...
                        <button
                          ...
                          className={`absolute top-2 right-2 px-2 py-0.5 rounded text-[8.5px] font-bold uppercase tracking-widest backdrop-blur-sm flex items-center gap-1 select-none pointer-events-auto cursor-pointer ${img.is_published
          ...
          {totalPages > 1 && (
            <div
              ...
              className="p-5 border-t border-slate-200 dark:border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-50 dark:bg-gray-800"
            >
              <span className="text-[10px] uppercase tracking-wider font-bold text-slate-500 dark:text-gray-400">
                Menampilkan <strong className="text-slate-900 dark:text-white">{Math.min((currentPage - 1) * itemsPerPage + 1, processedItems.length)}</strong> sampai{' '}
                <strong className="text-slate-900 dark:text-white">{Math.min(currentPage * itemsPerPage, processedItems.length)}</strong> dari{' '}
                <strong className="text-slate-900 dark:text-white">{processedItems.length}</strong> foto
              </span>
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-3 border-t border-slate-100 dark:border-gray-700 space-y-2.5 text-xs text-slate-600 dark:text-gray-300">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className={`px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider ${lightboxItem.is_published
