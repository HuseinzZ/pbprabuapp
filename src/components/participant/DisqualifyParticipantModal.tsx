...
export default function DisqualifyParticipantModal({ isOpen, participantName, onClose, onConfirm, isDisqualifying }: DisqualifyModalProps) {
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm transition-opacity duration-200">
      ...
      >
        ...
        <div className="flex flex-col items-center text-center space-y-3">
          <div className="p-3 bg-rose-50 dark:bg-rose-500/10 text-rose-600 rounded-lg border border-rose-200 dark:border-rose-500/20">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-gray-400 mt-1 max-w-xs mx-auto">
              Apakah Anda yakin ingin mendiskualifikasi peserta <strong className="text-slate-700 dark:text-gray-300">"{participantName}"</strong>?
            </p>
          </div>
        </div>
